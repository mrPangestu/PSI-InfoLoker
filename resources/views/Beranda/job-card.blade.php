@foreach ($jobs as $job)
    <div class="card shadow p-3 mb-2 bg-body" onclick="detail({{ $job->job_id }})">
        <div class="image">
        ...
        <div class="card-body">
            ...
            <p style="margin-top: 35px; font-size: 12px; height: 10px;"><i class="text-icon">{{ $job->updated_at ? 'Terakhir di Update pada ' . $job->updated_at->format('d-m-Y') : '' }}</i></p>
